                        ...
                        <Grid item container direction='row' justify="flex-start" alignItems="flex-start"
                            ...
                            <Grid item xs={5}>
                                <Typography variant='h6'
                                            style={{fontWeight: 500, lineHeight: '1.1'}}>{TimePeriod}</Typography>
                                <Typography
                                    style={{fontWeight: 200, lineHeight: '1.1', fontSize: '0.8rem'}}>срок</Typography>
                            </Grid>
                            <Grid item xs={7}>
                                <Typography variant='h6'
                                            style={{fontWeight: 500, lineHeight: '1.1'}}>{MinSum}</Typography>
                                <Typography style={{fontWeight: 200, lineHeight: '1.1', fontSize: '0.8rem'}}>Минимальная
                                    сумма</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                    ...
                    <Grid container direction='column'>
                        <Grid item>
                            <Typography variant='h3'
                                        style={{fontWeight: 600, lineHeight: '1.1'}}>{YearPercent}</Typography>
                        </Grid>
                        <Grid item>
                            <Typography style={{fontWeight: 300, lineHeight: '1.1', fontSize: '0.8rem'}}>Годовая
                                доходность</Typography>
                        </Grid>
                    </Grid>
                </CardActions>
            </CardActionArea>
